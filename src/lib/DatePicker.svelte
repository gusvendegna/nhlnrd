  ...
  <DatePicker.Root weekdayFormat="short" fixedWeeks={true} bind:value={date}>
    <div class="flex w-full max-w-[232px] flex-col gap-1.5">
      ...
      >
        ...
        {/each}
        <DatePicker.Trigger
          class="ml-auto size-8 items-center justify-center rounded-[5px] text-foreground/60 transition-all hover:bg-muted active:bg-dark-10 overflow-hidden"
        >
        <Calendar/>
        </DatePicker.Trigger>
